...
.btn-primary.active,.btn-primary:active,.btn-primary:focus,.btn-primary:active:focus,.btn-primary:hover,.btn-primary:active:hover,.open .dropdown-toggle.btn-primary {
	background-color: ${btn-expand-active};
	border-color: rgba(255,255,255,0);
	color: #fff
}
...
.btn-danger.active,.btn-danger:active,.btn-danger:focus,.btn-danger:hover,.btn-danger:active:focus,.btn-danger:active:hover,.open .dropdown-toggle.btn-danger {
	background-color: ${btn-collapse-active};
	border-color: rgba(255,255,255,0);
	color: #FFF
}
...
.chosen-container .chosen-results li.highlighted {
  ...
  background-image: -webkit-gradient(linear, left top, left bottom, color-stop(20%, ${color-banner}), color-stop(90%, ${color-banner}));
  background-image: linear-gradient(${color-banner} 20%, ${color-banner} 90%);
  color: #fff;
}
    </style>
</head>
...
<div class="row  border-bottom white-bg dashboard-header">
    <div class="col-sm-12 text-center">
        <span style="${title}">TesstReport</span>
    </div>
</div>
<div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5 style="${sub-title}">reportSummary</h5>
                    <div class="ibox-tools">
                        <a class="collapse-link">
                            <i class="fa fa-chevron-up"></i>
                        </a>
                        <a class="close-link" style="display: none">
                        ...
                        <div class="col-sm-6 b-r" style="height:350px">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-info">CaseName:</label>
                                    <div class="col-sm-5">
                                        <span class="form-control" id="testName"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-info">CaseTotals:</label>
                                    <div class="col-sm-5">
                                        <span class="form-control" id="testAll"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-navy">CasePass:</label>
                                    <div class="col-sm-5">
                                        <span class="form-control" id="testPass"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-danger">CaseFail:</label>
                                    <div class="col-sm-5">
                                        <span class="form-control text-danger" id="testFail"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-warning">CaseSkip:</label>
                                    <div class="col-sm-5">
                                        <span class="form-control text-warning" id="testSkip"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-info">StartTime:</label>
                                    <div class="col-sm-5">
                                        <span class="form-control" id="beginTime"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-info">RunTime:</label>
                                    <div class="col-sm-5">
    ...
    <div id="alert-tips" class="alert alert-danger alert-dismissible" role="alert">
         ...
         <strong>Warning!</strong> &nbsp;&nbsp;&nbsp;There are use cases reporting errors. Please view them first!
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5 style="${sub-title}">DetailsData</h5>
                    <div class="ibox-tools">
                        <a class="collapse-link">
                            <i class="fa fa-chevron-up"></i>
                        </a>
                ...
                <div class="ibox-content">
                    <div class="input-group panel-heading" style="width: 100%; background-color: ${color-banner}; margin-bottom: 10px; text-align: left; font-family: Consolas;">
                        <label style="color: snow">TsetClass:</label>
                        <select class="chosen-select form-control" data-placeholder="ALL" style="width: 300px;" name="filterClass" id="filterClass">
                            <option value="">ALL</option>
                        </select>
                        <label style="color: snow;margin-left: 10px;">result:</label>
                        <select class="chosen-select form-control" data-placeholder="ALL" style="width: 300px;" name="filterResult" id="filterResult">
                            <option value="">ALL</option>
                        </select>
                        <div style="float: right">
                            <label class="form-control">
                                <span class="text-info">Totals: </span><span class="text-info" id="filterAll">3</span><span> | </span>
                                <span class="text-success">Pass: </span><span class="text-success" id="filterOk">3</span><span> | </span>
                                <span class="text-danger">Fail: </span><span class="text-danger" id="filterFail">3</span><span> | </span>
                                <span class="text-warning">Skip: </span><span class="text-warning" id="filterSkip">3</span>
                            </label>
                        </div>
                    </div>
                ...
                series: [
                    {
                        ...
                        data: [
                            ...
                            {value: resultData["testPass"], name: 'success'}
                        ],
                        color: [
                                    "${color-fail}",
                                    "${color-skip}",
